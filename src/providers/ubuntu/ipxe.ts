...
kernel \${base_url}/assets/ubuntu/${version}/vmlinuz ip=dhcp url=\${base_url}/assets/ubuntu/${version}/${isoName} autoinstall ds=nocloud-net;s=\${base_url}/os/ubuntu/${mac}/ ramdisk_size=4500000
echo Loading Initrd...
